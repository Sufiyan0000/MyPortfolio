import { FaArrowRight, FaCode, FaGithub } from "react-icons/fa";

export function SeeAllProjects({ text, href, className = '' }) {
    return (
      <a
        href={href}
        target="_blank"
        ...
        className={`inline-flex items-center gap-2.5 px-3.5 py-2.5 rounded-full text-[12px] font-medium
